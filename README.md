...
A CV template
# Objet
Le but du travail pratique est de réaliser un template pour un Curriculum Vitae (CV). Cet exercice s'inscrit dans mon auto-formation en tant que developpeur Front-end.
# Technologies
